...
TEST_CASE("Format %f", "[string][printf]")
{
	...
	// Note: /fp:fast allows the compiler to disregard the sign of zero. MSVC
	// ARM64 folds this +0. literal into the -0. constant used above, so keep
	// the value opaque to the optimizer.
